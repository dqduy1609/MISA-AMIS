<template>
  <div class="m-combobox">
    ...
    <div class="m-combobox__body">
      ...
      <div
        v-if="isShow"
        class="m-combobox__menu"
        :style="[{ width: width }, { right: location }]"
      >
        <div class="m-table">
          <table>
...
export default {
  ...
  methods: {
    ...
    /**
     * Thay đổi lại class cho các item đc chọn 
     * CreatedBy: DQDUY (10/3/2022)
     */
    checkItem(value) {
      let temp = false;
    ...
    /**
     * Đóng cbb khi blur khỏi ô input
     * CreatedBy: DQDUY (10/3/2022)
     */
    blurCbb() {
      this.isShow = false;
    ...
    /**
     * Hiện ra option khi click vào icon
     * CreatedBy: DQDUY (10/3/2022)
     */
    dropdown() {
    ...
    /**
     * Hiện ra option khi có sự kiện nhập từ bàn phím
     * CreatedBy: DQDUY (10/3/2022)
     */
    clickout() {
      this.isShow = true;
